...
void CardTableManager::CardImageLoad(int uid, CAttribute  ait, CType type, Star star)
{
	...
	case E_Attack:
		...
		case E_ONE:
			...
			{
			case E_BULGOGI:
				RENDER.SetImage(L"images/cards/attack_1_1.png", to_string(uid),
					Gdiplus::Rect(0, 0, CARDX, CARDY), Gdiplus::Rect(0, 0, 0, 0), false,
					GameImage_M::LayerType::Card);
				break;
			case E_CHESSE:
				RENDER.SetImage(L"images/cards/attack_1_2.png", to_string(uid),
					Gdiplus::Rect(0, 0, CARDX, CARDY), Gdiplus::Rect(0, 0, 0, 0), false,
					GameImage_M::LayerType::Card);
				break;
			case E_VEGAT:
				RENDER.SetImage(L"images/cards/attack_1_3.png", to_string(uid),
					Gdiplus::Rect(0, 0, CARDX, CARDY), Gdiplus::Rect(0, 0, 0, 0), false,
					GameImage_M::LayerType::Card);
				break;
			case E_SOURCE:
				RENDER.SetImage(L"images/cards/attack_1_4.png", to_string(uid),
					Gdiplus::Rect(0, 0, CARDX, CARDY), Gdiplus::Rect(0, 0, 0, 0), false,
					GameImage_M::LayerType::Card);
				break;
			}
		...
		case E_TWO:
			...
			{
			case E_BULGOGI:
				RENDER.SetImage(L"images/cards/attack_2_1.png", to_string(uid),
					Gdiplus::Rect(0, 0, CARDX, CARDY), Gdiplus::Rect(0, 0, 0, 0), false,
					GameImage_M::LayerType::Card);
				break;
			case E_CHESSE:
				RENDER.SetImage(L"images/cards/attack_2_2.png", to_string(uid),
					Gdiplus::Rect(0, 0, CARDX, CARDY), Gdiplus::Rect(0, 0, 0, 0), false,
					GameImage_M::LayerType::Card);
				break;
			case E_VEGAT:
				RENDER.SetImage(L"images/cards/attack_2_3.png", to_string(uid),
					Gdiplus::Rect(0, 0, CARDX, CARDY), Gdiplus::Rect(0, 0, 0, 0), false,
					GameImage_M::LayerType::Card);
				break;
			case E_SOURCE:
				RENDER.SetImage(L"images/cards/attack_2_4.png", to_string(uid),
					Gdiplus::Rect(0, 0, CARDX, CARDY), Gdiplus::Rect(0, 0, 0, 0), false,
					GameImage_M::LayerType::Card);
				break;
			case E_BREAD:
				RENDER.SetImage(L"images/cards/attack_2_5.png", to_string(uid),
					Gdiplus::Rect(0, 0, CARDX, CARDY), Gdiplus::Rect(0, 0, 0, 0), false,
					GameImage_M::LayerType::Card);
				break;
			}
		...
		case E_THREE:
			...
			{
			case E_BULGOGI:
				RENDER.SetImage(L"images/cards/attack_3_1.png", to_string(uid),
					Gdiplus::Rect(0, 0, CARDX, CARDY), Gdiplus::Rect(0, 0, 0, 0), false,
					GameImage_M::LayerType::Card);
				break;
			case E_CHESSE:
				RENDER.SetImage(L"images/cards/attack_3_2.png", to_string(uid),
					Gdiplus::Rect(0, 0, CARDX, CARDY), Gdiplus::Rect(0, 0, 0, 0), false,
					GameImage_M::LayerType::Card);
				break;
			case E_VEGAT:
				RENDER.SetImage(L"images/cards/attack_3_3.png", to_string(uid),
					Gdiplus::Rect(0, 0, CARDX, CARDY), Gdiplus::Rect(0, 0, 0, 0), false,
					GameImage_M::LayerType::Card);
				break;
			case E_SOURCE:
				RENDER.SetImage(L"images/cards/attack_3_4.png", to_string(uid),
					Gdiplus::Rect(0, 0, CARDX, CARDY), Gdiplus::Rect(0, 0, 0, 0), false,
					GameImage_M::LayerType::Card);
				break;
			}
	...
	case E_Deffense:
		...
		case E_ONE:
			...
			{
			case E_BULGOGI:
				RENDER.SetImage(L"images/cards/def_1_1.png", to_string(uid),
					Gdiplus::Rect(0, 0, CARDX, CARDY), Gdiplus::Rect(0, 0, 0, 0), false,
					GameImage_M::LayerType::Card);
				break;
			case E_CHESSE:
				RENDER.SetImage(L"images/cards/def_1_2.png", to_string(uid),
					Gdiplus::Rect(0, 0, CARDX, CARDY), Gdiplus::Rect(0, 0, 0, 0), false,
					GameImage_M::LayerType::Card);
				break;
			case E_VEGAT:
				RENDER.SetImage(L"images/cards/def_1_3.png", to_string(uid),
					Gdiplus::Rect(0, 0, CARDX, CARDY), Gdiplus::Rect(0, 0, 0, 0), false,
					GameImage_M::LayerType::Card);
				break;
			case E_SOURCE:
				RENDER.SetImage(L"images/cards/def_1_4.png", to_string(uid),
					Gdiplus::Rect(0, 0, CARDX, CARDY), Gdiplus::Rect(0, 0, 0, 0), false,
					GameImage_M::LayerType::Card);
				break;
			}
		...
		case E_TWO:
			...
			{
			case E_BULGOGI:
				RENDER.SetImage(L"images/cards/def_2_1.png", to_string(uid),
					Gdiplus::Rect(0, 0, CARDX, CARDY), Gdiplus::Rect(0, 0, 0, 0), false,
					GameImage_M::LayerType::Card);
				break;
			case E_CHESSE:
				RENDER.SetImage(L"images/cards/def_2_2.png", to_string(uid),
					Gdiplus::Rect(0, 0, CARDX, CARDY), Gdiplus::Rect(0, 0, 0, 0), false,
					GameImage_M::LayerType::Card);
				break;
			case E_VEGAT:
				RENDER.SetImage(L"images/cards/def_2_3.png", to_string(uid),
					Gdiplus::Rect(0, 0, CARDX, CARDY), Gdiplus::Rect(0, 0, 0, 0), false,
					GameImage_M::LayerType::Card);
				break;
			case E_SOURCE:
				RENDER.SetImage(L"images/cards/def_2_4.png", to_string(uid),
					Gdiplus::Rect(0, 0, CARDX, CARDY), Gdiplus::Rect(0, 0, 0, 0), false,
					GameImage_M::LayerType::Card);
				break;
			case E_BREAD:
				RENDER.SetImage(L"images/cards/def_2_5.png", to_string(uid),
					Gdiplus::Rect(0, 0, CARDX, CARDY), Gdiplus::Rect(0, 0, 0, 0), false,
					GameImage_M::LayerType::Card);
				break;
			}
		...
		case E_THREE:
			...
			{
			case E_BULGOGI:
				RENDER.SetImage(L"images/cards/def_3_1.png", to_string(uid),
					Gdiplus::Rect(0, 0, CARDX, CARDY), Gdiplus::Rect(0, 0, 0, 0), false,
					GameImage_M::LayerType::Card);
				break;
			case E_CHESSE:
				RENDER.SetImage(L"images/cards/def_3_2.png", to_string(uid),
					Gdiplus::Rect(0, 0, CARDX, CARDY), Gdiplus::Rect(0, 0, 0, 0), false,
					GameImage_M::LayerType::Card);
				break;
			case E_VEGAT:
				RENDER.SetImage(L"images/cards/def_3_3.png", to_string(uid),
					Gdiplus::Rect(0, 0, CARDX, CARDY), Gdiplus::Rect(0, 0, 0, 0), false,
					GameImage_M::LayerType::Card);
				break;
			case E_SOURCE:
				RENDER.SetImage(L"images/cards/def_3_4.png", to_string(uid),
					Gdiplus::Rect(0, 0, CARDX, CARDY), Gdiplus::Rect(0, 0, 0, 0), false,
					GameImage_M::LayerType::Card);
				break;
			}
		...
		break;
	case E_Magic:
		RENDER.SetImage(L"images/cards/magic_3.png", to_string(uid),
			Gdiplus::Rect(0, 0, CARDX, CARDY), Gdiplus::Rect(0, 0, 0, 0), false,
			GameImage_M::LayerType::Card);
		break;
	}
